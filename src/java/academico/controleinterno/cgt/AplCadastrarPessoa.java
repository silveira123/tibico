...
//        aluno.setDataNascimento((Calendar) args.get(1));
//        aluno.setCpf((Long) args.get(2));
//        aluno.setIdentidade((String) args.get(3));
//        aluno.setEmail((String) args.get(4));
//        aluno.setSexo((Sexo) args.get(5));
//        aluno.setEndereco((Endereco) args.get(6));
//        aluno.setTelefone((ArrayList<Telefone>) args.get(7));
//        aluno.setMatricula((Long) args.get(8));
//        aluno.setNomePai((String) args.get(9));
//        aluno.setNomeMae((String) args.get(10));
...
//        professor.setDataNascimento((Calendar) args.get(1));
//        professor.setCpf((Long) args.get(2));
//        professor.setIdentidade((String) args.get(3));
//        professor.setEmail((String) args.get(4));
//        professor.setSexo((Sexo) args.get(5));
//        professor.setEndereco((Endereco) args.get(6));
//        professor.setTelefone((ArrayList<Telefone>) args.get(7));
